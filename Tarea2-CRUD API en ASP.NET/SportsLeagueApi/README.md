...
¡Hola! Soy **Brayner Melo** y este es mi proyecto para la Tarea 2 de Desarrollo de Software. He construido un **Web API** robusto utilizando **ASP.NET Core** y **Entity Framework Core** para gestionar equipos y jugadores de una liga deportiva.
...
---
*Proyecto realizado para la asignatura de Desarrollo de Software - ITLA.*
